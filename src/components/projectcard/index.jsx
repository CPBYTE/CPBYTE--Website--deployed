...
const ProjectCard = ({ title, projectImage, imageUrl, developer, profileLink, projectLink }) => {
  return (
    <div className="w-full max-w-[20rem] glass-card border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:border-blue-500/30 hover:shadow-blue-500/10 transition-all duration-300">
      <a href={projectLink}>
