        ...
        <div className="p-2">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {coordinators.map((member) => (
              <div
                key={member.id}
                className="glass-card flex flex-col items-center p-8 transition-all duration-300 transform cursor-pointer group border border-white/10 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 rounded-2xl"
              >
                <img
                  className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-700 group-hover:ring-blue-500/50 transition-all duration-300"
                  src={member.image}
                  alt={member.name}
                />
                ...
                <div className="flex mt-4 -mx-2">
                  <a
                    ...
                    className="mx-2 text-gray-500 hover:text-blue-400 transition-colors duration-300"
                    aria-label="LinkedIn"
                    target="_blank"
                  ...
                  <a
                    href={member.github}
                    className="mx-2 text-gray-500 hover:text-white transition-colors duration-300"
                    aria-label="Github"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
